<template>
  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-6 text-center">
      ...
      <h1 class="font-display text-3xl font-black tracking-tight text-[#23394e] lg:text-4xl">
        Find Your Perfect
        <span class="text-[#f29200]">Workspace</span>
      </h1>

      <p class="mx-auto mt-3 max-w-xl text-sm leading-6 text-[#9f9f9f]">
        Discover and book flexible offices, coworking spaces, and meeting rooms.
      </p>
